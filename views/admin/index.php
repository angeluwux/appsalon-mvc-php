...
<div class="notificacion contenedor">
    <?= $cantCitas === 0 ? '<h2>No hay citas en esta fecha</h2>' : '' ?>
</div>
    ...
    <ul class="citas">
        ...
        ?>
                <li>
                    ...
                    <p>WhatsApp: <span><a href="https://wa.me/<?= $cita->telefono ?>">Contactar por WhatsApp</a></span></p>
            ...
            $total += $cita->precio;
                ...
                if (esUltimo($actual, $proximo)) { ?>
                    ...
                    <form action="/api/eliminar" method="POST" class="frm">
